...
(function() {
  var base58, blake2s, crypto, helpers, key, msgpack, nacl, startup_date, startup_hrtime, value,
    __slice = [].slice;
  ...
  helpers = {
    ...
    millis: function() {
      ...
      return startup_date + (diff[0] * 1000) + ((diff[1] / 1000000) | 0);
    },
    blake: function() {
    ...
    randomID: function(octets) {
      ...
      out = (function() {
        ...
        _results = [];
        for (group = _i = 0, _ref = buff.length; _i < _ref; group = _i += 4) {
          _results.push(buff.readUInt32LE(group).toString(36));
        }
        return _results;
      })();
      return out.join('-');
